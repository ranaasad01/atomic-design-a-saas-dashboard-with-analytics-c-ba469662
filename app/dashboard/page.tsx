...
const kpiCards = [
  {
    ...
    icon: Users,
    color: "#6366F1",
    bg: "from-red-500/10 to-violet-500/5",
    format: "number",
  },
  {
    ...
    icon: DollarSign,
    color: "#10B981",
    bg: "from-red-500/10 to-teal-500/5",
    format: "currency",
  },
  {
    label: "Churn Rate",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-1 bg-white dark:bg-gray-900 border border-black/5 dark:border-white/10 rounded-xl p-1 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
              ...
              {DATE_RANGES.map((range) => (
                <button
                  ...
                  className={`px-3 py-1.5 text-xs font-semibold rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 ${
                    dateRange === range
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 border-b border-black/5 dark:border-white/10">
            ...
            <span className="text-xs font-medium text-red-600 dark:text-red-400 hover:underline cursor-pointer">
              {t("dashboard.viewAll")}
            </span>
          </div>

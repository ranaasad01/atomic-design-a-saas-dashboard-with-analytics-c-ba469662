              ...
              >
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-black/5 dark:border-white/5">
                  <img
                    src={t_item.avatar}
                    alt={t_item.name}
                    className="w-9 h-9 rounded-full object-cover ring-2 ring-indigo-100 dark:ring-indigo-500/20"
                    onError={(e) => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-indigo-200 leading-relaxed max-w-lg mx-auto mb-8 text-pretty">
                {t("cta.subtitle")}
              </p>

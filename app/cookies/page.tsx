      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shadow-[0_2px_12px_rgba(99,102,241,0.4)]">
              <Cookie className="w-5 h-5 text-white" />
            </div>
            <span className="text-sm font-medium text-indigo-600 dark:text-indigo-400 tracking-wide uppercase">
              Cookie Policy
            </span>
          </motion.div>
        ...
        <motion.div
          ...
          className="bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-2xl p-6 mb-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-white/10 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
            >
              Essential only
            </button>
            <button
              onClick={handleAcceptAll}
              className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl transition-all duration-200 shadow-[0_2px_8px_rgba(99,102,241,0.35)] hover:shadow-[0_4px_16px_rgba(99,102,241,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
            >
              Accept all
            </button>
          </div>
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 flex items-center gap-4">
                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${isEnabled ? "bg-indigo-50 dark:bg-indigo-500/15" : "bg-gray-100 dark:bg-white/5"}`}>
                      <Icon className={`w-4.5 h-4.5 ${isEnabled ? "text-indigo-600 dark:text-indigo-400" : "text-gray-400 dark:text-gray-500"}`} style={{ width: "18px", height: "18px" }} />
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {cat.required && (
                          <span className="text-[10px] font-semibold uppercase tracking-wider text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/15 px-2 py-0.5 rounded-full">
                            Required
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <button
                        ...
                        className={`relative w-11 h-6 rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 ${
                            ...
                            <tbody className="divide-y divide-black/5 dark:divide-white/5">
                              {(cat.examples ?? []).map((ex, i) => (
                                <tr key={i} className="bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-white/3 transition-colors duration-150">
                                  <td className="px-4 py-3 font-mono text-indigo-600 dark:text-indigo-400 font-medium whitespace-nowrap">{ex.name}</td>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className={`flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-xl transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
                saved
                  ? "bg-green-500 text-white shadow-[0_2px_8px_rgba(34,197,94,0.35)]"
                  : "bg-indigo-600 hover:bg-indigo-700 text-white shadow-[0_2px_8px_rgba(99,102,241,0.35)] hover:shadow-[0_4px_16px_rgba(99,102,241,0.45)]"
              }`}
            >
              {saved ? (
                <>
        ...
        >
          ...
          >
            {[
              ...
              { browser: "Apple Safari", steps: "Preferences > Privacy > Manage Website Data", color: "from-blue-400 to-indigo-500" },
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between px-5 py-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-inset"
                  >
        ...
        >
          <motion.div
            variants={scaleIn}
            className="bg-gradient-to-br from-indigo-50 to-violet-50 dark:from-indigo-500/10 dark:to-violet-500/10 border border-indigo-100 dark:border-indigo-500/20 rounded-2xl p-8 text-center"
          >
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center mx-auto mb-4 shadow-[0_4px_16px_rgba(99,102,241,0.4)]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl transition-all duration-200 shadow-[0_2px_8px_rgba(99,102,241,0.35)] hover:shadow-[0_4px_16px_rgba(99,102,241,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
              >
                Contact Privacy Team
              </a>
              <a
                href="/privacy"
                className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-white/10 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
              >
                Privacy Policy

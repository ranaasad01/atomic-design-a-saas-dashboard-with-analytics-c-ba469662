        ...
        >
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 border border-black/5 dark:border-white/10 rounded-xl hover:text-red-600 dark:hover:text-red-400 transition-all duration-200 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4 pt-4 border-t border-black/5 dark:border-white/5">
              {[
                ...
                { label: t("analytics.cold"), value: weeklyQualityData.reduce((s, d) => s + d.cold, 0), color: "text-red-500", bg: "bg-red-50 dark:bg-red-500/10" },
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6">
              ...
              <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                <span className="flex items-center gap-1.5">
                  <span className="w-3 h-3 rounded-sm bg-red-200 dark:bg-red-500/40 flex-shrink-0" />
                  {t("analytics.revenue")}
                </span>
                <span className="flex items-center gap-1.5">
